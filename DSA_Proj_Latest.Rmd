...
NN_model2 = nnetar(wiki_daily_split$train)
autoplot(msts_wiki_daily)+autolayer(forecast(NN_model2, h = 482))
accuracy(forecast(NN_model2, h= 482), wiki_daily_split$test)
```
