...
start_indexes <- seq(1, length(views) - (max_len + 1), by = 7)
...
rnn_model %>%
    layer_dense(units = 1, activation = 'tanh') # output
summary(rnn_model)
...
rnn_model %>% evaluate(X_test, y_test, batch_size = batch_size)
```
