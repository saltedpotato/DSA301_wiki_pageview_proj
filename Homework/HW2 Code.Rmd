...
```
From part (a), we can see that the variance of the autoplot is not constant and increases with the level, and therefore BoxCox transformation should be employed.
